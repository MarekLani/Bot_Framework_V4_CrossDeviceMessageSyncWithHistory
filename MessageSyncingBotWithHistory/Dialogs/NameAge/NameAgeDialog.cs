...
using MessageSyncingBotWithHistory.Dialogs.CancelAndHelp;
using MessageSyncingBotWithHistory.Dialogs.NameAge.Resources;
using MessageSyncingBotWithHistory.Models;
using System;
using System.Threading;
using System.Threading.Tasks;
using Microsoft.Bot.Schema;

namespace MessageSyncingBotWithHistory.Dialogs.NameAge
{
    public class NameAgeDialog : CancelAndHelpDialog
    {
        ...
        private async Task<DialogTurnResult> SayHiAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            //var act = stepContext.Context.Activity;
